...
<footer class="w-[98vw] h-[20em] bg-black m-auto rounded-t-[4em] relative overflow-hidden">
  ...
  <div class="footerContent mr-6 py-10 text-center md:text-left">
    <div class="grid grid-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
      ...
      <div class="grid ml-44">
        <center>
        <h6 class="uppercase text-xl font-bold mb-4 text-[#3f5a60]">
          Produkter
        </h6>
        <p class="mb-4 hover:border-x-2 border-cyangreen p-1">
        ...
        <p>
          <a href="#!" class="text-gray-50 hover:border-x-2 border-cyangreen p-1">Tilmeld dig nyhedsbrev</a>
        </p>
        </center>
      </div>
      <div class="contact">
        
        <h6 class="uppercase font-bold text-xl mb-4 text-[#3f5a60]">
          Kontakt os
        </h6>
        <center>
        <p class="flex items-center justify-center md:justify-start mb-4">
          ...
          Jørgensens Allè 28<br>8722 Hedensted
        </p>
        </center>
        <p class="flex items-center justify-center md:justify-start mb-4">
          ...
          <a href="mailto:Kaare@musikmekanikeren.dk" class=" hover:border-x-2 p-1 border-cyangreen"> Kaare@musikmekanikeren.dk </a>
        </p>
        <p class="flex items-center justify-center md:justify-start mb-4">
          ...
          <a href="tel:60217602" class=" hover:border-x-2 p-1 border-cyangreen"> 60 21 76 02 </a>
        </p>
