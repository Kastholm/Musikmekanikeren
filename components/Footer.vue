...
<footer class="w-[95vw] h-[20em] bg-black m-auto rounded-t-[4em] relative overflow-hidden">
    <video class="absolute w-[42em] right-0 bottom-0" autoplay muted loop playsinline crossorigin="">
		<source src="/video/bg1.mp4" type="video/mp4">
	</video>
  <div class="footerContent mx-6 py-10 text-center md:text-left">
    <div class="grid grid-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
      ...
      <div class="grid place-content-center">
        ...
        <p class="mb-4">
          <a href="#!" class="text-gray-600">Skoleservice</a>
        </p>
        <p class="mb-4">
          <a href="#!" class="text-gray-600">Service</a>
        </p>
        <p class="mb-4">
          <a href="#!" class="text-gray-600">Produkter</a>
        </p>
        <p>
          <a href="#!" class="text-gray-600">Tilmeld dig nyhedsbrev</a>
        </p>
      </div>
      <div class="contact">
        <h6 class="uppercase font-semibold mb-4 flex justify-center md:justify-start">
  ...
  <!-- <footer class="text-center lg:text-left bg-gray-100 text-gray-600 relative z-10 ">
  <div class="flex justify-center items-center lg:justify-between p-6 border-b border-gray-300">
    <div class="mr-12 hidden lg:flex gap-2 justify-center">
      <span class="m-auto"> Find os på Facebook</span>
      
      <a href="#!" class="m-auto text-gray-600">
